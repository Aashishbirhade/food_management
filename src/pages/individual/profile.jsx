...
//           <div className="w-1/5 bg-zinc-800 rounded-lg p-8 space-y-8 text-center">
//             <div className="  ">
//               <img
...
//               <div className="w-3/5 bg-zinc-800 p-8  rounded-lg">
...
//                 <div></div>
//               </div>
//               <div className="bg-zinc-800 w-2/5 p-5 text-lg text-center rounded-md h-96 overflow-y-auto">
...
//         </div>
//       </div>
//       <div className="text-white px-8 bg-black py-2  flex gap-10">
//         <div className=" w-1/2 bg-zinc-800 rounded-lg p-8">
...
//               className="bg-sky-700 hover:bg-sky-400 shadow-lg w-32 rounded-lg text-lg font-semibold text-white hover:text-black h-10"
//             >
//               Submit
//             </button>
//           </div>
      ...
      <div>
        <div className="text-white p-8 bg-black flex gap-10">
          ...
          <motion.div
            ...
            transition={{ duration: 1 }} // Duration of the sliding effect
          >
            <div className="bg-blue-700 h-40 p-2 w-40 items-center  rounded-full" >
              <img
                src={profileImage}
                alt="Profile"
